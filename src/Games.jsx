...
function Games() {
  ...
  return (
    <main>
      <section className={`player player--0 ${activePlayer === 0 ? 'player--active' : ''} ${isWinner(0) ? 'player--winner' : ''}`}>
        <h2 className="name" id="name--0">{player1}</h2>
      ...
      <section className={`player player--1 ${activePlayer === 1 ? 'player--active' : ''} ${isWinner(1) ? 'player--winner' : ''}`}>
        <h2 className="name" id="name--1">{player2}</h2>
      ...
      <img src={`src/assets/dice-${dice || 5}.png`} alt="Playing dice" className={`dice ${dice ? '' : 'hidden'}`} />
